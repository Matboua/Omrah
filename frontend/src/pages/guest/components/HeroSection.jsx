...
export default function HeroSection() {
	return (
		<section className="relative col-span-10 col-start-2 flex flex-col-reverse gap-20 md:gap-0 md:flex-row justify-between items-center min-h-[calc(100vh-64px)] py-5">
			{/* Left */}
